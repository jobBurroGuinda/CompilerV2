    ...
    public LinkedList<Token> lex(String input) {
        ...
        while (matcher.find()) {
            ...
            if (matcher.group(TokenType.FLOAT.name()) != null) {
                ...
                tokens.add(new Token(TokenType.VAR, matcher.group(TokenType.VAR.name()), matcher.start()));

                continue;

            } else if (matcher.group(TokenType.VAL.name()) != null) {

                tokens.add(new Token(TokenType.VAL, matcher.group(TokenType.VAL.name()), matcher.start()));
            ...
            } else if (matcher.group(TokenType.ASSIGNTYPE.name()) != null) {

                tokens.add(new Token(TokenType.ASSIGNTYPE, matcher.group(TokenType.ASSIGNTYPE.name()), matcher.start()));
